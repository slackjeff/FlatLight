...
* **Alternancia Inteligente (Toggle):** A mesma interface detecta automaticamente o estado do aplicativo — se já estiver instalado, o Flatlight realiza a remoção; caso contrário, executa a instalação.
* **Atalhos Uteis:** Comandos integrados para selecionar (`Ctrl+A`) ou desmarcar (`Ctrl+D`) todos os itens instantaneamente.
* **Leve e Eficiente:** Escrito em Bash puro, com dependências minimas e baixo consumo de recursos.
